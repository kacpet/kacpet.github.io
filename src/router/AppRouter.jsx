...
function AppRouter({ theme, language }) {
    ...
    return (
        <Routes>
            ...
            <Route
                path="/rock-paper-scissors-game/:id"
                element={<RockPaperScizzorsRoom theme={theme} language={language} />}
            />
            <Route
                path="/rock-paper-scissors-result/:id"
                element={<RockPaperScizzorsGame theme={theme} language={language} />}
            />
            ...
            {langPages.map((page) => (
                <Route
                    key={page.path}
                    path={page.path}
                    element={<LangPage theme={theme} language={language} data={page.data} />}
                />
            ))}
            ...
            {toolsPages.map((page) => (
                <Route
                    key={page.path}
                    path={page.path}
                    element={<ToolsPage theme={theme} language={language} data={page.data} />}
                />
            ))}
            ...
            {langProjects.map((page) => (
                <Route
                    key={page.path}
                    path={page.path}
                    element={<LangProjects theme={theme} language={language} data={page.data} />}
                />
            ))}
        </Routes>
    );
