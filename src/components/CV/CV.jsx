...
function Cv({ theme, language }) {
    ...
    const t = {
        polish: {
            ...
            focusDesc: "Tworzenie nowoczesnych aplikacji webowych z naciskiem na UI, UX oraz wydajność.",
        },
        ...
        english: {
            ...
            focusDesc: "Creating modern web applications focused on UI, UX and performance.",
        },
    };
    ...
    function renderSkill(skill, index) {
        return (
            <div key={index} className="skill-item">
                ...
                <span className="skill-more" onClick={() => navigate(skill.path)}>
                    {text.more} →
                </span>
            </div>
        );
                ...
                <div className="cv-grid">
                    ...
                    <div className="cv-right">
                        <div className="cv-card" style={{ "--d": "0.18s" }}>
                            ...
                            <div className="skill-grid">{skills.database.map(renderSkill)}</div>
                            <h3>{text.tools}</h3>
