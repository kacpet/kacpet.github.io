const icons = {
    javascript: (
        <svg viewBox="0 0 630 630">
            ...
            <path
                d="M423 492c13 21 30 36 61 36 25 0 41-12 41-29 0-20-16-27-42-38l-14-6c-40-17-67-38-67-83 0-41 31-72 80-72 35 0 60 12 78 43l-43 28c-9-17-20-24-35-24-16 0-27 10-27 24 0 17 11 24 36 35l14 6c47 20 74 41 74 89 0 51-40 79-94 79-52 0-85-25-101-58z
           M244 497c9 16 17 30 37 30 19 0 31-7 31-37V301h52v190c0 58-34 84-83 84-44 0-69-23-82-50z"
                fill="#000"
            />
        </svg>
    ),
    ...
    angular: (
        <svg viewBox="-8 0 272 272">
            <g>
                ...
                />
                <path
                    d="M126.107393,32.27393 L47.7136187,206.692607 L76.9992218,206.194553 L92.7377432,166.848249 L126.207004,166.848249 L163.063035,166.848249 L180.29572,206.692607 L208.286381,207.190661 L126.107393,32.27393 Z
             M126.306615,88.155642 L152.803113,143.5393 L102.997665,143.5393 L126.306615,88.155642 Z"
                    fill="#FFFFFF"
                />
            </g>
        </svg>
    ...
    vue: (
        <svg viewBox="0 0 261.76 226.69">
            <polygon fill="#41B883" points="0,0 130.88,226.69 261.76,0" />
            <polygon fill="#35495E" points="52,0 130.88,143 209,0" />
        </svg>
    ),
    ...
    python: (
        <svg
            ...
            width="24"
        >
            <desc>Python Streamline Icon: https://streamlinehq.com</desc>
            <path
                fill="url(#a)"
                d="M47.6611 1.24463c-23.863 0-22.3728 10.34847-22.3728 10.34847l.0266 10.7209h22.7719v3.2189H16.27S1 23.8011 1 47.8792c-.000002 24.078 13.328 23.2241 13.328 23.2241h7.9542V59.9302s-.4288-13.328 13.1151-13.328H57.983s12.6895.2052 12.6895-12.2638V13.7213S72.5991 1.24463 47.6611 1.24463ZM35.1047 8.45396c2.2656 0 4.0968 1.83114 4.0968 4.09684 0 2.2656-1.8312 4.0968-4.0968 4.0968-2.2657 0-4.0968-1.8312-4.0968-4.0968 0-2.2657 1.8311-4.09684 4.0968-4.09684Z"
            ></path>
            <path
                fill="url(#b)"
                d="M48.3393 94.7555c23.8631 0 22.3729-10.3484 22.3729-10.3484l-.0266-10.7209H47.9137v-3.2189h31.8168s15.27 1.7317 15.27-22.3463-13.328-23.2242-13.328-23.2242h-7.9542v11.1731s.4288 13.328-13.1151 13.328H38.0175S25.328 49.1928 25.328 61.6618v20.6171s-1.9267 12.4766 23.0113 12.4766Zm12.5565-7.2093c-2.2657 0-4.0968-1.8312-4.0968-4.0968 0-2.2657 1.8311-4.0968 4.0968-4.0968 2.2656 0 4.0968 1.8311 4.0968 4.0968 0 2.2656-1.8312 4.0968-4.0968 4.0968Z"
            ></path>
            <defs>
                <linearGradient
                    id="a"
    ...
    sql: (
        <svg viewBox="0 0 128 128">
            <ellipse cx="64" cy="30" rx="40" ry="18" fill="#4479A1" />
            <path d="M24 30v68c0 10 18 18 40 18s40-8 40-18V30" fill="#4479A1" />
            <ellipse cx="64" cy="98" rx="40" ry="18" fill="#2F5E7A" />
        </svg>
    ),
    ...
    gitlab: (
        <svg
            ...
            fill="none"
            viewBox="0 0 24 24"
            id="Gitlab--Streamline-Svg-Logos"
            height="24"
            width="24"
        >
            ...
            <path
                fill="#e24329"
                d="m11.999975 22.82365 4.327 -13.317075h-8.654l4.327 13.317075Z"
                stroke-width="0.25"
            ></path>
            <path
                fill="#fc6d26"
                d="m12.000075 22.823625 -4.327 -13.317075H1.6088875L12.000075 22.823625Z"
                stroke-width="0.25"
            ></path>
            <path
                fill="#fca326"
                d="M1.60881 9.5066 0.2939125 13.55355c-0.1199335 0.3691 0.0114225 0.77345 0.32542 1.001575L12 22.823675 1.60881 9.5066Z"
                stroke-width="0.25"
            ></path>
            <path
                fill="#e24329"
                d="M1.6088875 9.5066H7.673075L5.0669 1.485865c-0.134025 -0.4127675 -0.717925 -0.4126575 -0.85195 0L1.6088875 9.5066Z"
                stroke-width="0.25"
            ></path>
            <path fill="#fc6d26" d="m12 22.823625 4.327 -13.317075h6.0642L12 22.823625Z" stroke-width="0.25"></path>
            <path
                fill="#fca326"
                d="m22.3912 9.5066 1.3149 4.04695c0.119925 0.3691 -0.011425 0.77345 -0.325425 1.001575L12 22.823675l10.3912 -13.317075Z"
                stroke-width="0.25"
            ></path>
            <path
                fill="#e24329"
                d="M22.391225 9.5066H16.327025L18.9332 1.485865c0.13405 -0.4127675 0.717925 -0.4126575 0.85195 0L22.391225 9.5066Z"
                stroke-width="0.25"
            ></path>
        </svg>
    ),
...
function Icon({ name }) {
    return <span className="skill-icon">{icons[name] ?? null}</span>;
}
