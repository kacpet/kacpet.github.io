...
const FigmaData = (theme) => ({
  ...
  description: {
    polish:
      "Figma wykorzystuję do projektowania interfejsów użytkownika, tworzenia prototypów oraz współpracy nad designem w czasie rzeczywistym. Jest bardzo wygodna do pracy zespołowej i UI/UX.",
