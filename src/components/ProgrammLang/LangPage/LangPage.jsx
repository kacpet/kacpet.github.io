...
function LangPage({ theme, language, data }) {
            ...
            <div className="lang-container">
                ...
                <header className="lang-hero">
                    <div className="lang-logo-wrapper" style={{ "--d": "0.05s" }}>
                        <div className="lang-logo">{data.logo}</div>
                    </div>

                    <div className="lang-heading" style={{ "--d": "0.15s" }}>
                        <span className="lang-subtitle">{data.category}</span>

                        <h1 className="lang-title">{data.title}</h1>

                        <p className="lang-description">{data.description[language]}</p>
                        ...
                        <button
                            ...
                            style={{ "--d": "0.25s" }}
                        >
                            {language === "polish" ? "Zobacz projekty" : "View projects"}
                        </button>
                    </div>
                </header>
                ...
                <div className="lang-grid">
                    ...
                    <section className="lang-card" style={{ "--d": "0.25s" }}>
                        <div className="section-top">
                            ...
                            <h2>{language === "polish" ? "Umiejętności" : "Skills"}</h2>
                        </div>
